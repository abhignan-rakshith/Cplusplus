...
/*
The below can be used with <iomanip> & <ios>:

1. std::endl or \n : places a new line character on the output stream.
2. std::flush : flushes the output buffer to its final destination.
3. std::setw(int) : sets the field width to the specified value.
4. std::right : sets the justification to right.
5. std::internal : sets the justification to internal.
6. std::setfill(char) : sets the fill character to the specified value.
7. std::boolalpha/noboolalpha : sets the boolalpha flag to true.
8. std::showpos/noshowpos : sets the showpos flag to true.
9. std::dec/hex/oct : sets the number base to decimal/hex/octal. (No effect on floating point numbers)
10. std::showbase/hidebase : sets the showbase flag to true.
11. std::uppercase/ nouppercase : sets the uppercase flag to true.
12. std::scientific/noscientific : sets the scientific flag to true.
13. std::fixed/nofixed : sets the fixed flag to true.
14. std::setprecision(int) : sets the precision to the specified value.
15. std::showpoint/noshowpoint : sets the showpoint flag to true.
*/
