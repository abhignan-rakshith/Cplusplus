...
#include <iomanip>
/*My learning notes:
1. std::setprecision() : To control the precision from std::cout, using <iomanip>.
2. Remember to add suffix 'f' and 'L' for float and long double.
3. float is 7 digits, double is 15, and long double is 15+.
4. Scientific notations: 1e6, 1e-6.
5. Infinity and NaN. (+inf, -inf, NaN, nan)
*/
